...
static const char* connectionString = "HostName=iot-test-sdk.azure-devices.net;DeviceId=desktop_dps;SharedAccessKey=5cVC4QXXlBUjEh22BQl/QUQlDfj5OX1WBCkn/NjeKTA=";
    ...
    else
    {
        ...
        do
        {
            if (messages_sent < MESSAGE_COUNT)
            {
                ...
                IoTHubDeviceClient_LL_SendEvent(device_ll_handle, message_handle);
